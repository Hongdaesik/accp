...
function setExcute() {
  ...
  try {
    ...
    for ( let entry of FS.readdirSync( api ) ) {
      ...
      // check ext
      if ( PATH.extname( entry ).indexOf( '.api' ) < 0 ) {
  ...
  // get manufacture
  var manufacture = getManufacture( paths )

  // check manufacture
  if ( manufacture ) {

    setPrint( '!', 'Start pattern process\n', 'brightGreen' )
    ...
    setPrint( '!', 'Complete pattern process', 'brightGreen' )
  }
}
      ...
      if ( variable && variable.length > 0 ) {
        ...
        switch ( _deep ) {
          ...
          case 3: {
            ...
            // set option
            _cur.OPTION[ variable[ 1 ] ] = variable[ 2 ].concat( variable[ 3 ] )
        ...
        if ( RegExp( /^(import\s{1}(.*?)$)/g ).test( line ) ) {
          ...
          switch ( ext ) {
            ...
            case '.code': {
              ...
              if ( getCode( name, data, report.code ) ) {
            ...
            case '.struct': {
              ...
              if ( getStruct( name, data, verify.struct, report.struct ) ) {
        ...
        if ( variable && variable.length > 0 ) {
          ...
          switch ( variable[ 1 ] ) {
            ...
            case 'COMP': {
              ...
              cur[ variable[ 1 ] ] = Boolean( variable[ 2 ] )
            ...
            switch ( _key.NAME ) {
              ...
              case 'RES': {
                ...
                switch ( _deep ) {
                  ...
                  case 5: {
                    ...
                    // set option
                    _cur.OPTION[ variable[ 1 ] ] = variable[ 2 ]
              ...
              case 'MARK': {
                ...
                _key.DATA.push( {
                  ...
                  NAME: variable[ 1 ],
                  MARK: variable[ 2 ].concat( variable[ 3 ] )
                } )
